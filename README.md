# Generated pinning service models

This repo contains generated (and then edited) pinning service models.

For more information about the pinning service spec, see [https://github.com/ipfs/pinning-services-api-spec/](here).
For more information about openapi-generator, see [https://openapi-generator.tech](here).


If this is generated, then why is it edited?

Ideally, it shouldnt' be. But the openapi generator seems to produce some broken output.

I'll document the changes in this README.


To re-generate this code, simply run the following:
```
make clean generate
```
...
- API version: 1.0.0
- Build date: 2023-03-25T15:10:12.260432761-07:00[US/Pacific]
