...
// checks if the PinStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinStatus{}
...
type _PinStatus PinStatus

// NewPinStatus instantiates a new PinStatus object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPinStatus(requestid string, status Status, created time.Time, pin Pin, delegates Delegates) *PinStatus {
	this := PinStatus{}
...
func (o *PinStatus) GetDelegates() Delegates {
	if o == nil {
		var ret Delegates
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PinStatus) GetDelegatesOk() (*Delegates, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PinStatus) SetDelegates(v Delegates) {
	o.Delegates = v
}

// GetInfo returns the Info field value if set, zero value otherwise.
func (o *PinStatus) GetInfo() StatusInfo {
...
// and a boolean to check if the value has been set.
func (o *PinStatus) GetInfoOk() (*StatusInfo, bool) {
	if o == nil || IsNil(o.Info) {
		return nil, false
	}
	return o.Info, true
...
func (o *PinStatus) SetInfo(v StatusInfo) {
	o.Info = &v
}
...
func (o PinStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PinStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varPinStatus := _PinStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPinStatus)

	if err != nil {
		return err
	}

	*o = PinStatus(varPinStatus)
