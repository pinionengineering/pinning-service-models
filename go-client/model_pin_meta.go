...
// checks if the PinMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinMeta{}
...
type _PinMeta PinMeta

// NewPinMeta instantiates a new PinMeta object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPinMeta() *PinMeta {
	this := PinMeta{}
	return &this
}

// NewPinMetaWithDefaults instantiates a new PinMeta object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPinMetaWithDefaults() *PinMeta {
	this := PinMeta{}
	return &this
}

func (o PinMeta) MarshalJSON() ([]byte, error) {
...
func (o PinMeta) ToMap() (map[string]interface{}, error) {
...
func (o *PinMeta) UnmarshalJSON(data []byte) (err error) {
	varPinMeta := _PinMeta{}

	err = json.Unmarshal(data, &varPinMeta)

	if err != nil {
		return err
	}

	*o = PinMeta(varPinMeta)
...
type NullablePinMeta struct {
	value *PinMeta
	isSet bool
}

func (v NullablePinMeta) Get() *PinMeta {
	return v.value
}

func (v *NullablePinMeta) Set(val *PinMeta) {
	v.value = val
	v.isSet = true
}

func (v NullablePinMeta) IsSet() bool {
	return v.isSet
}

func (v *NullablePinMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePinMeta(val *PinMeta) *NullablePinMeta {
	return &NullablePinMeta{value: val, isSet: true}
}

func (v NullablePinMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePinMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
