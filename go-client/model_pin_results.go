...
// checks if the PinResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinResults{}
...
func (o PinResults) ToMap() (map[string]interface{}, error) {
...
func (o *PinResults) UnmarshalJSON(data []byte) (err error) {
	...
	varPinResults := _PinResults{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPinResults)

	if err != nil {
		return err
	}

	*o = PinResults(varPinResults)
