...
// NewDelegates instantiates a new Delegates object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDelegates() Delegates {
	return Delegates{}
}

// NewDelegatesWithDefaults instantiates a new Delegates object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDelegatesWithDefaults() Delegates {
	return Delegates{}
}

type NullableDelegates struct {
	value Delegates
	isSet bool
}

func (v NullableDelegates) Get() Delegates {
	return v.value
}

func (v *NullableDelegates) Set(val Delegates) {
	v.value = val
	v.isSet = true
}

func (v NullableDelegates) IsSet() bool {
	return v.isSet
}

func (v *NullableDelegates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDelegates(val Delegates) *NullableDelegates {
	return &NullableDelegates{value: val, isSet: true}
}

func (v NullableDelegates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDelegates) UnmarshalJSON(src []byte) error {
	v.isSet = true
