...
// and a boolean to check if the value has been set.
func (o *Pin) GetOriginsOk() (*Origins, bool) {
	if o == nil || IsNil(o.Origins) {
		return nil, false
	}
...
// SetOrigins gets a reference to the given Origins and assigns it to the Origins field.
func (o *Pin) SetOrigins(v Origins) {
	o.Origins = &v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *Pin) GetMeta() PinMeta {
...
// and a boolean to check if the value has been set.
func (o *Pin) GetMetaOk() (*PinMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
// SetMeta gets a reference to the given PinMeta and assigns it to the Meta field.
func (o *Pin) SetMeta(v PinMeta) {
	o.Meta = &v
}
