...
// checks if the FailureError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailureError{}
...
type _FailureError FailureError
...
func (o FailureError) ToMap() (map[string]interface{}, error) {
...
func (o *FailureError) UnmarshalJSON(data []byte) (err error) {
	...
	varFailureError := _FailureError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFailureError)

	if err != nil {
		return err
	}

	*o = FailureError(varFailureError)
