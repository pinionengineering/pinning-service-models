...
func (r ApiGetPinsRequest) Meta(meta PinMeta) ApiGetPinsRequest {
	r.meta = &meta
	return r
}
...
func (a *PinsAPIService) GetPinsExecute(r ApiGetPinsRequest) (*PinResults, *http.Response, error) {
	...
	if r.cid != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cid", r.cid, "form", "csv")
	}
	if r.name != nil {
	...
	if r.match != nil {
		...
		var defaultValue TextMatchingStrategy = "exact"
