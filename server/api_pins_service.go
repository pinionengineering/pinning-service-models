...
func (s *PinsApiService) AddPin(ctx context.Context, pin Pin) (ImplResponse, error) {
	// TODO - update AddPin with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("AddPin method not implemented")
}
...
func (s *PinsApiService) DeletePinByRequestId(ctx context.Context, requestid string) (ImplResponse, error) {
	// TODO - update DeletePinByRequestId with the required logic for this service method.
	// Add api_pins_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("DeletePinByRequestId method not implemented")
}
...
func (s *PinsApiService) GetPinByRequestId(ctx context.Context, requestid string) (ImplResponse, error) {
	// TODO - update GetPinByRequestId with the required logic for this service method.
	// Add api_pins_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetPinByRequestId method not implemented")
}

// GetPins - List pin objects
func (s *PinsApiService) GetPins(ctx context.Context, cid []string, name string, match TextMatchingStrategy, status []Status, before time.Time, after time.Time, limit int32, meta PinMeta) (ImplResponse, error) {
	// TODO - update GetPins with the required logic for this service method.
	// Add api_pins_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetPins method not implemented")
}
...
func (s *PinsApiService) ReplacePinByRequestId(ctx context.Context, requestid string, pin Pin) (ImplResponse, error) {
	// TODO - update ReplacePinByRequestId with the required logic for this service method.
	// Add api_pins_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
