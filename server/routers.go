	...
	return []Route{
		{
			...
			http.MethodPost,
			"/pins",
			handleFunctions.PinsAPI.AddPin,
		},
		{
			"DeletePinByRequestId",
			http.MethodDelete,
			"/pins/:requestid",
			handleFunctions.PinsAPI.DeletePinByRequestId,
		},
		{
			"GetPinByRequestId",
			http.MethodGet,
			"/pins/:requestid",
			handleFunctions.PinsAPI.GetPinByRequestId,
		},
		{
			"GetPins",
			http.MethodGet,
			"/pins",
			handleFunctions.PinsAPI.GetPins,
		},
		{
			"ReplacePinByRequestId",
			http.MethodPost,
			"/pins/:requestid",
			handleFunctions.PinsAPI.ReplacePinByRequestId,
		},
	}
}
